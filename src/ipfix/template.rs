...
/// Set header (4) + template record header (4) + 9 fields × 4 bytes,
/// twice over for the two templates: 4 + 2 × (4 + 36) = 84.
pub const TEMPLATE_SET_LEN: usize = 84;
...
mod tests {
    ...
    #[rustfmt::skip]
    const EXPECTED: &[u8] = &[
        // Set header: set_id=2, length=84
        0x00, 0x02, 0x00, 0x54,
        // Template 256 header: template_id=256, field_count=9
        0x01, 0x00, 0x00, 0x09,
        ...
        // Template 257 header: template_id=257, field_count=9
        0x01, 0x01, 0x00, 0x09,
        // Template 257 fields
